...
public class ItemSpellPapers extends Item {
	...
	public void addInformation(ItemStack stack, World worldIn, List<String> tooltip, ITooltipFlag flagIn) {
		tooltip.add("§3" + I18n.format("item.spellPaper.cost") + " : " + cost);
		if (isActive(stack)) {
			tooltip.add("§3" + I18n.format("item.spellPaper.state") + " : " + I18n.format("item.spellPaper.enable"));
		} else {
			tooltip.add("§3" + I18n.format("item.spellPaper.state") + " : " + I18n.format("item.spellPaper.disable"));
		}
	}
