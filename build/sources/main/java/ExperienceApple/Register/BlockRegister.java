...
public class BlockRegister {
	...
	public static void init(Side side) {
		...
		register(path, "path");
		register(rottenDirt, "rottenDirt");
		register(enrichedFarmLand, "enrichedFarmLand");
		...
		register(rackManager, "rackManager");
		...
		register(wEIHopper, "wEIHopper");
		register(eIHopper, "eIHopper");

	}

	public static void register(Block block, String str) {
		// BlockRegister.register(block, new ResourceLocation(EAMain.MOD_ID +
		// ":" + str));
