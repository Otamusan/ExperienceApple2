...
public class TileAwakenedSpawner extends TileEntity implements ITickable {
	private final AwekenedSpawnerBaseLogic spawnerLogic = new AwekenedSpawnerBaseLogic() {
		public void broadcastEvent(int id) {
			TileAwakenedSpawner.this.world.addBlockEvent(TileAwakenedSpawner.this.pos, BlockRegister.awakenedSpawner,
					id, 0);
		}

		public World getSpawnerWorld() {
			return TileAwakenedSpawner.this.world;
		}

		public BlockPos getSpawnerPosition() {
			return TileAwakenedSpawner.this.pos;
		}
		...
		public void setNextSpawnData(WeightedSpawnerEntity p_184993_1_) {
			...
			if (this.getSpawnerWorld() != null) {
				...
				this.getSpawnerWorld().notifyBlockUpdate(TileAwakenedSpawner.this.pos, iblockstate, iblockstate, 4);
			}
		}
	};
	...
	public AwekenedSpawnerBaseLogic getSpawnerBaseLogic() {
