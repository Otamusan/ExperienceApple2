...
public abstract class AwekenedSpawnerBaseLogic {
			...
			if (this.getSpawnerWorld().isRemote) {
				...
				for (int i = 0; i < this.spawnCount; ++i) {
					...
					if (entityliving == null
							|| net.minecraftforge.event.ForgeEventFactory.canEntitySpawnSpawner(entityliving,
									getSpawnerWorld(), (float) entity.posX, (float) entity.posY, (float) entity.posZ)) {
